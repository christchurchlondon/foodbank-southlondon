...
requests_params = flask_restx.reqparse.RequestParser()
...
requests_params.add_argument("last_req_only", type=bool, required=False, help="Whether only the most recent request per Reference Number will be "
                             "fetched")
