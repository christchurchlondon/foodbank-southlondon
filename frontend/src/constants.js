...
export const TAB_REQUESTS = '[tab] REQUESTS';
export const TAB_LISTS = '[tab] LISTS';
...
export const DATE_FORMAT_UI_LONG = 'dd/MM/yyyy HH:mm:ss';
export const DATE_FORMAT_REQUEST = 'yyyy-MM-dd';
export const DATE_FORMAT_TIMESTAMP = 'yyyy-MM-dd HH:mm:ss';// HH:mm:SS';
